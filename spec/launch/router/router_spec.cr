    ...
    describe Router do
      describe "#resources" do
        it "defines all resources" do
          router = Launch::Router::Router.new
      ...
      describe "#route_defined?" do
        ...
        it "returns true when route exists" do
          ...
          route = Launch::Router::Route.new("GET", "/hello/world", handler)
          router.add(route)
      ...
      describe "#add" do
        it "register a GET route" do
          ...
          route = Launch::Router::Route.new("GET", "/some/joe", handler)
          router.add(route)
        end
        ...
        it "correctly passes constraints from Route as Hash" do
          ...
          route = Launch::Router::Route.new("GET", "/posts/:slug", handler, :index, :web, Launch::Router::Scope.new, "PostsController", {"slug" => /\d\d\-\w+/})
          router.add(route)
      ...
      describe "#match_by_controller_action" do
        ...
        router = Launch::Router::Router.new
        route_a = Launch::Router::Route.new("GET", "/fake", handler, :index, :web, Launch::Router::Scope.new, "FakeController")
        route_b = Launch::Router::Route.new("GET", "/fake/new", handler, :new, :web, Launch::Router::Scope.new, "FakeController")
        route_c = Launch::Router::Route.new("GET", "/fake/:id", handler, :show, :web, Launch::Router::Scope.new, "FakeController")
        route_d = Launch::Router::Route.new("GET", "/another/:id", handler, :another, :web, Launch::Router::Scope.new, "FakeController")
